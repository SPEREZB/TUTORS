  ...
  <svelte:fragment slot="header">
    <NavigationPrimary>
      ...
      <svelte:fragment slot="trail">
        {#if !isNotCourseRoute}
          <a href="http://localhost:3000/course/reference-course">
            <i class="fa-solid fa-house fa-bounce" style="color: #67cd65;" />
          </a>

          <a href="javascript:history.back()">
            <i class="fa-solid fa-left-long fa-beat" style="color: #67cd65;" />
          </a>
